...
*/`
            ...
            overloadsBuf.indented(() => {
                ...
                switch (opDef.operator_kind) {
                    ...
                    case genutil_2.$.OperatorKind.Prefix:
                        ...
                        break;
                    case genutil_2.$.OperatorKind.Postfix:
            ...
            overloadsBuf.indented(() => {
                overloadsBuf.writeln([
                    (0, builders_1.t) `${returnType.staticType}, ${(0, generateFunctionTypes_1.generateReturnCardinality)(opName, params, opDef.return_typemod, false, anytypes)}`
                ]);
            });
            overloadsBuf.writeln([(0, builders_1.t) `>;`]);
        }
