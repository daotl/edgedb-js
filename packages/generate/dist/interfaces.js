...
async function runInterfacesGenerator(params) {
    ...
    const types = await edgedb_1.$.introspect.types(cxn);
    ...
    const rendered = `// GENERATED by @edgedb/generate v${(0, commandutil_1.getPackageVersion)()}\n` +
